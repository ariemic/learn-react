...
function List({ title, items, render }) {
  ...
  return (
    <div className="list-container">
      ...
      {/* we used inverstion of control with render - now list doesn't know what is rendering, only knows that render is a function*/}
...
// LATER: Let's say we got this component from a 3rd-party library, and can't achange it. But we still want to add the 2 toggle functionalities to it
